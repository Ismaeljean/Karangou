    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero', models.CharField(blank=True, default='', max_length=15, null=True)),
                ('role', models.CharField(choices=[('auteur', 'Auteur'), ('acteur', 'Acteur'), ('producteur', 'Producteur'), ('fan', 'Fan')], default='auteur', max_length=20)),
